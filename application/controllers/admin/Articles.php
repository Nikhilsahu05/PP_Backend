...
class Articles extends Admin_Controller {
	...
	public function ajax_list() {
        ...
        foreach ($list as $key => $post) {
	        $action = '';
            $action .= '<a href="articles/edit/'.$post->id.'" class="btn btn-primary waves-effect waves-light"><i class="fe-edit"></i></a> <button type="button" class="btn btn-dark waves-effect waves-light post_delete_confirmation" data-toggle="modal" data-target="#post_deleted" data-id='.$post->id.'><i class="fe-trash-2"></i></button>';
