...
class SagePay {
	...
	public function __construct($id = NULL) {
		$this->encryptPassword = getenv('FORM_INTEGRATION_ENCRYPTION_PASSWORD');
		$this->setVendorTxCode($this->createVendorTxCode($id));
	}
	...
	protected function createVendorTxCode($id) {
