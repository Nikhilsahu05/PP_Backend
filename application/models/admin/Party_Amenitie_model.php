...
class Party_Amenitie_model extends CI_Model {

    var $order = array('party_amenities.id' => 'desc'); // default order

    public function __construct() {
        parent::__construct();

        $this->table = 'party_amenities';
        $this->table_category = 'party_category';
    ...
    public function check_party_amenitie($full_name) {
        return $this->db->get_where($this->table, ['name' => $full_name])->row();
    }

     public function get_party_category($cat_id) {
        return $this->db->get_where($this->table_category, ['id' => $cat_id])->row();
    }

      public function get_all_party_category() {
    ...
    public function party_amenitie_details($id) {
