...
class Party_Category_model extends CI_Model {

    var $order = array('party_category.id' => 'desc'); // default order

    public function __construct() {
        parent::__construct();

        $this->table = 'party_category';
    ...
    public function check_party_category($full_name) {
    ...
    public function party_category_details($id) {
