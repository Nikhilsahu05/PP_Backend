        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                         <a href="<?php echo base_url('admin/organization/org_pdf_add'); ?>" class="btn btn-primary waves-effect waves-light float-right"><i class="fe-plus"></i> Add New</a>
                            <br><br>
                            <div class="table-responsive">
                                <table id="datatable-org_pdf" class="table dt-responsive nowrap">
                                    <thead>
                                        <tr>
                                            <th>S.No</th>
                                            <th>PDF A</th>
