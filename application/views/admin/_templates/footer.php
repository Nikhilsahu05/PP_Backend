...
?>
        ...
        <?php endif; ?>
              ...
              <?php
               ...
               if ($this->router->fetch_class()== 'Party_Category'): ?>
        <script src="<?php echo base_url($frameworks_dir . '/admin/'); ?>js/party_category.js"></script>
        <?php endif; ?>

              <?php if ($this->router->fetch_class()== 'Party_Amenitie'): ?>
        <script src="<?php echo base_url($frameworks_dir . '/admin/'); ?>js/party_amenitie.js"></script>
        <?php endif; ?>
        ...
        <script src="<?php echo base_url($frameworks_dir . '/admin/'); ?>js/organization.js"></script>
        <?php endif; ?>
        <?php if ($this->router->fetch_class()== 'Organization_Amenitie'): ?>
        <script src="<?php echo base_url($frameworks_dir . '/admin/'); ?>js/organization_amenitie.js"></script>
        <?php endif; ?>
