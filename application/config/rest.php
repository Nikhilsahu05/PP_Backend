...
/*
|--------------------------------------------------------------------------
| REST Auth Key Variable
|--------------------------------------------------------------------------
|
| Custom header to specify the Auth key

|
*/
$config['rest_authorization_key'] = getenv('REST_HEADER_AUTH_KEY');
...
|--------------------------------------------------------------------------
|
| The field name for the response status inside the response
|
*/
$config['rest_status_code_one'] 				= 1;
$config['rest_status_code_zero']  				= 0;
$config['rest_status_code_two'] 				= 2;
$config['rest_status_unauthentication_code']  	= 403;
